...
class MXPixArtSigmaPipeline(DiffusionPipeline):
    r"""
    ...
    ## added transformer to the optional components
    _optional_components = ["tokenizer", "text_encoder", "transformer"]
    ...
    def __init__(
        ...
        vae: AutoencoderKL,
        transformer: MXPixArtTransformer2DModel,
    ...
    def encode_prompt(
        ...
        **kwargs,
        ...
        if prompt_embeds is None:
            ...
            print(f"text_emb length: {text_inputs['attention_mask'].sum().item()}")
