...
from .customize_transformer_block import MXBasicTransformerBlock

logger = logging.get_logger(__name__)  # pylint: disable=invalid-name
# models/pixart_transformer_2d.py - add this class to the existing file
...
# class MXPixArtTransformer2DModel(PixArtTransformer2DModel):
#     """MX Quantized version of PixArtTransformer2DModel."""
...
#         ex_pred=False,
#     ):
#         # Call parent's init with standard parameters
#         super().__init__(
...
class MXPixArtTransformer2DModel(ModelMixin, ConfigMixin):
    r"""
    A 2D Transformer model as introduced in PixArt family of models (https://arxiv.org/abs/2310.00426,
    https://arxiv.org/abs/2403.04692).
    ...
    _supports_gradient_checkpointing = True
    _no_split_modules = ["MXBasicTransformerBlock", "PatchEmbed"]
    _skip_layerwise_casting_patterns = ["pos_embed", "norm", "adaln_single"]
    ...
    def __init__(
        ...
        ## MX-specific quantization configs initialization
        self.mx_quant = False
        self.mx_specs = None
