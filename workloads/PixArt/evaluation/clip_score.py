...
def main(args):
    ...
    # Fix warnings by using fast processor and disabling rescaling
    metric = CLIPScore(
    ...
    scores = []
    for idx, prompt in enumerate(tqdm(prompts, desc="Calculating CLIP scores")):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img-pth", type=str, default="../evaluation/generated_images/top128/ex_pred/")
