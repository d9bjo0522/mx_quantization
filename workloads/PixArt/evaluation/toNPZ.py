...
# def create_npz_from_sample_folder(sample_dir, npz_dir, num=5000):
#     """
#     Builds a single .npz file from a folder of .png samples.
#     """
#     samples = []
#     for i in tqdm(range(num), desc="Building .npz file from samples"):
#         sample_pil = Image.open(f"{sample_dir}/{i}.jpg")
#         sample_np = np.asarray(sample_pil).astype(np.uint8)
#         samples.append(sample_np)
#     samples = np.stack(samples)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample_dir", type=str, default="/work/tttpd9bjo/diffusion/PixArt/PixArt-XL-2/evaluation/generated_images/alpha-256/top128/true_exp/")
    parser.add_argument("--npz_dir", type=str, default="/work/tttpd9bjo/diffusion/PixArt/PixArt-XL-2/evaluation/generated_images/alpha-256/top128/true_exp/npz")
    parser.add_argument("--file_name", type=str, default="val2017_5000")
